...
// proj 2
$(".pop-up-two").on("click", function() {
    $(".overlay-two").addClass("is-on");
});
$("#closee").on("click", function() {
    $(".overlay-two").removeClass("is-on");
});
// proj 3
$(".pop-up-three").on("click", function() {
    $(".overlay-three").addClass("is-on");
});
$("#closeee").on("click", function() {
    $(".overlay-three").removeClass("is-on");
});
// proj 4
$(".pop-up-four").on("click", function() {
    $(".overlay-four").addClass("is-on");
});
$("#closeeee").on("click", function() {
    $(".overlay-four").removeClass("is-on");
});
